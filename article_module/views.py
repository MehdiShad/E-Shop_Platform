...
#             'articles': articles
#         }
#         return render(request, 'article_module/article_page.html', context=context)
...
def article_categories_component(request: HttpRequest):
    ...
    return render(request, 'article_module/components/article_categories_component.html', context=context)
...
def add_article_comment(request: HttpRequest):
    if request.user.is_authenticated:
        ...
        return render(request, 'article_module/includes/article_comments_partial.html', context=context)
